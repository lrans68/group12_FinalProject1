    ...
    <form id="form1" runat="server">
        <div>
            <asp:Table ID="tbButtons" runat="server" HorizontalAlign="Center">
                <asp:TableHeaderRow>
                    <asp:TableCell>
                        <asp:Button ID="btnEasy" onclick="BtnEasy_Click" runat="server" Text="Easy" CssClass="button-92" role="button"/>
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:Button ID="btnMedium" onclick="BtnMedium_Click" runat="server" Text="Medium" CssClass="button-92" role="button"/>
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:Button ID="btnHard" onclick="BtnHard_Click" runat="server" Text="Hard" CssClass="button-92" role="button"/>
                    </asp:TableCell>
                </asp:TableHeaderRow>
                <asp:TableRow>
                    <asp:TableCell></asp:TableCell>
                    <asp:TableCell>
                        <asp:Button ID="btnClear" OnClick="btnClear_Click" runat ="server" Text="Clear" CssClass="button-92" role="button" />
                    </asp:TableCell>
                </asp:TableRow>
                 </asp:Table>
            <asp:Table>
